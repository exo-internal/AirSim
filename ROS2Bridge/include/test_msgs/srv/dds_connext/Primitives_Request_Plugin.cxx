    ...
    namespace srv {
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                Primitives_Request_ *sample = NULL;

                sample = new (std::nothrow) Primitives_Request_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!test_msgs::srv::dds_::Primitives_Request__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Primitives_Request_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!test_msgs::srv::dds_::Primitives_Request__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return test_msgs::srv::dds_::Primitives_Request_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Primitives_Request_PluginSupport_destroy_data_w_params(
                ...
                test_msgs::srv::dds_::Primitives_Request__finalize_w_params(sample,dealloc_params);
            ...
            Primitives_Request_PluginSupport_destroy_data_ex(
                ...
                test_msgs::srv::dds_::Primitives_Request__finalize_ex(sample,deallocate_pointers);
            ...
            Primitives_Request_PluginSupport_destroy_data(
                ...
                test_msgs::srv::dds_::Primitives_Request_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return test_msgs::srv::dds_::Primitives_Request__copy(dst,(const Primitives_Request_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    test_msgs::srv::dds_::Primitives_Request_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    test_msgs::srv::dds_::Primitives_Request_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                Primitives_Request__finalize_optional_members(sample, RTI_TRUE);
                ...
                const Primitives_Request_ *src)
            {
                ...
                return test_msgs::srv::dds_::Primitives_Request_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        test_msgs::srv::dds_::Primitives_Request__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const Primitives_Request_ *sample)
            {
                ...
                result = test_msgs::srv::dds_::Primitives_Request_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                Primitives_Request__finalize_optional_members(sample, RTI_TRUE);
                return Primitives_Request_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!Primitives_Request_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                data = DDS_DynamicData_new(
                    Primitives_Request__get_typecode(), 
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "Primitives_Request_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::srv::dds_::Primitives_Request_Plugin_deserialize_sample( 
            ...
            RTIBool Primitives_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = Primitives_Request_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!test_msgs::srv::dds_::Primitives_Request_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
            ...
            RTIBool Primitives_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Primitives_Request_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!test_msgs::srv::dds_::Primitives_Request_Plugin_deserialize_sample(
            ...
            RTIBool Primitives_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Primitives_Request_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::srv::dds_::Primitives_Request_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = Primitives_Request_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *Primitives_Request_Plugin_new(void) 
            { 
                ...
                test_msgs::srv::dds_::Primitives_Request_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                test_msgs::srv::dds_::Primitives_Request_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                test_msgs::srv::dds_::Primitives_Request_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                test_msgs::srv::dds_::Primitives_Request_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                Primitives_Request_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                Primitives_Request_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                Primitives_Request__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                Primitives_Request_Plugin_get_sample;
                ...
                test_msgs::srv::dds_::Primitives_Request_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)test_msgs::srv::dds_::Primitives_Request__get_typecode();
                ...
                Primitives_Request_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                Primitives_Request_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                test_msgs::srv::dds_::Primitives_Request_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = Primitives_Request_TYPENAME;

                return plugin;
            }

            void
            Primitives_Request_Plugin_delete(struct PRESTypePlugin *plugin)
            {
