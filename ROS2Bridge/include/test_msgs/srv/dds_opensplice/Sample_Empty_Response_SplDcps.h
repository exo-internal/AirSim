...
#include "test_msgs/srv/dds_opensplice/Empty_Response_SplDcps.h"

#include "test_msgs/msg/rosidl_typesupport_opensplice_cpp__visibility_control.h"

extern c_metaObject __Sample_Empty_Response__test_msgs__load (c_base base);

extern c_metaObject __Sample_Empty_Response__test_msgs_srv__load (c_base base);

extern c_metaObject __Sample_Empty_Response__test_msgs_srv_dds___load (c_base base);
