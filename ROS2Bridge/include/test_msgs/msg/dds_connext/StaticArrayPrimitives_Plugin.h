...
#ifndef StaticArrayPrimitives_Plugin_1531885840_h
#define StaticArrayPrimitives_Plugin_1531885840_h
...
namespace test_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__boolean_array_3*
            ...
            test_msgs__StaticArrayPrimitives__boolean_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__boolean_array_3 *out,
                const test_msgs__StaticArrayPrimitives__boolean_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__boolean_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__boolean_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__octet_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__octet_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__octet_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__octet_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__octet_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__octet_array_3*
            ...
            test_msgs__StaticArrayPrimitives__octet_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__octet_array_3 *out,
                const test_msgs__StaticArrayPrimitives__octet_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__octet_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__octet_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__octet_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__char_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__char_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__char_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__char_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__char_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__char_array_3*
            ...
            test_msgs__StaticArrayPrimitives__char_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__char_array_3 *out,
                const test_msgs__StaticArrayPrimitives__char_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__char_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__char_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__char_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__float_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__float_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__float_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__float_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__float_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__float_array_3*
            ...
            test_msgs__StaticArrayPrimitives__float_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__float_array_3 *out,
                const test_msgs__StaticArrayPrimitives__float_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__float_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__float_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__float_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__double_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__double_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__double_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__double_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__double_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__double_array_3*
            ...
            test_msgs__StaticArrayPrimitives__double_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__double_array_3 *out,
                const test_msgs__StaticArrayPrimitives__double_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__double_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__double_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__double_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__short_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__short_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__short_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__short_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__short_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__short_array_3*
            ...
            test_msgs__StaticArrayPrimitives__short_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__short_array_3 *out,
                const test_msgs__StaticArrayPrimitives__short_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__short_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__short_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__short_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__unsigned_short_array_3*
            ...
            test_msgs__StaticArrayPrimitives__unsigned_short_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__unsigned_short_array_3 *out,
                const test_msgs__StaticArrayPrimitives__unsigned_short_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__unsigned_short_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__unsigned_short_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__long_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__long_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__long_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__long_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__long_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__long_array_3*
            ...
            test_msgs__StaticArrayPrimitives__long_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__long_array_3 *out,
                const test_msgs__StaticArrayPrimitives__long_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__long_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__long_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__long_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__unsigned_long_array_3*
            ...
            test_msgs__StaticArrayPrimitives__unsigned_long_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__unsigned_long_array_3 *out,
                const test_msgs__StaticArrayPrimitives__unsigned_long_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__unsigned_long_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__unsigned_long_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__long_long_array_3*
            ...
            test_msgs__StaticArrayPrimitives__long_long_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__long_long_array_3 *out,
                const test_msgs__StaticArrayPrimitives__long_long_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__long_long_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__long_long_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3*
            ...
            test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3 *out,
                const test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__unsigned_long_long_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define test_msgs__StaticArrayPrimitives__string_array_3Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define test_msgs__StaticArrayPrimitives__string_array_3Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define test_msgs__StaticArrayPrimitives__string_array_3Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define test_msgs__StaticArrayPrimitives__string_array_3Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define test_msgs__StaticArrayPrimitives__string_array_3Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern test_msgs__StaticArrayPrimitives__string_array_3*
            ...
            test_msgs__StaticArrayPrimitives__string_array_3PluginSupport_copy_data(
                test_msgs__StaticArrayPrimitives__string_array_3 *out,
                const test_msgs__StaticArrayPrimitives__string_array_3 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            test_msgs__StaticArrayPrimitives__string_array_3Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            test_msgs__StaticArrayPrimitives__string_array_3Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                test_msgs__StaticArrayPrimitives__string_array_3 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            #define StaticArrayPrimitives_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define StaticArrayPrimitives_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define StaticArrayPrimitives_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define StaticArrayPrimitives_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define StaticArrayPrimitives_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern StaticArrayPrimitives_*
            ...
            StaticArrayPrimitives_PluginSupport_copy_data(
                StaticArrayPrimitives_ *out,
                const StaticArrayPrimitives_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            StaticArrayPrimitives_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            StaticArrayPrimitives_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                StaticArrayPrimitives_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            StaticArrayPrimitives_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                StaticArrayPrimitives_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            StaticArrayPrimitives_Plugin_new(void);

            NDDSUSERDllExport extern void
            StaticArrayPrimitives_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* StaticArrayPrimitives_Plugin_1531885840_h */
