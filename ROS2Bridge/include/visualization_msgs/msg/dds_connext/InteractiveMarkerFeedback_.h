...
#ifndef InteractiveMarkerFeedback__1449233729_h
#define InteractiveMarkerFeedback__1449233729_h
...
namespace visualization_msgs {
    namespace msg {
        namespace dds_ {
            static const DDS_Octet InteractiveMarkerFeedback__KEEP_ALIVE= 0;
            static const DDS_Octet InteractiveMarkerFeedback__POSE_UPDATE= 1;
            static const DDS_Octet InteractiveMarkerFeedback__MENU_SELECT= 2;
            static const DDS_Octet InteractiveMarkerFeedback__BUTTON_CLICK= 3;
            static const DDS_Octet InteractiveMarkerFeedback__MOUSE_DOWN= 4;
            static const DDS_Octet InteractiveMarkerFeedback__MOUSE_UP= 5;
