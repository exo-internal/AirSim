...
#ifndef InteractiveMarkerUpdate__1532886462_h
#define InteractiveMarkerUpdate__1532886462_h
...
namespace visualization_msgs {
    namespace msg {
        namespace dds_ {
            static const DDS_Octet InteractiveMarkerUpdate__KEEP_ALIVE= 0;
            static const DDS_Octet InteractiveMarkerUpdate__UPDATE= 1;
