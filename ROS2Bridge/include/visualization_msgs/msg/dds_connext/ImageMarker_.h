...
#ifndef ImageMarker__1698718002_h
#define ImageMarker__1698718002_h
...
namespace visualization_msgs {
    namespace msg {
        namespace dds_ {
            static const DDS_Octet ImageMarker__CIRCLE= 0;
            static const DDS_Octet ImageMarker__LINE_STRIP= 1;
            static const DDS_Octet ImageMarker__LINE_LIST= 2;
            static const DDS_Octet ImageMarker__POLYGON= 3;
            static const DDS_Octet ImageMarker__POINTS= 4;
            static const DDS_Octet ImageMarker__ADD= 0;
            static const DDS_Octet ImageMarker__REMOVE= 1;
