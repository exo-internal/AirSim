...
namespace composition {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *LoadNode_Response_TYPENAME = "composition::srv::dds_::LoadNode_Response_";

            DDS_TypeCode* LoadNode_Response__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode_Member LoadNode_Response__g_tc_members[1]=
                {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"composition::srv::dds_::LoadNode_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool LoadNode_Response__initialize(
                ...
                return composition::srv::dds_::LoadNode_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                LoadNode_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return composition::srv::dds_::LoadNode_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                LoadNode_Response_* sample)
            {
                ...
                composition::srv::dds_::LoadNode_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                LoadNode_Response_* sample,RTIBool deletePointers)
            {
                ...
                composition::srv::dds_::LoadNode_Response__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params composition::srv::dds_::LoadNode_Response__initialize_w_params

            #define T_finalize_w_params   composition::srv::dds_::LoadNode_Response__finalize_w_params
            #define T_copy       composition::srv::dds_::LoadNode_Response__copy
