#ifndef SAMPLE_GETSTATE_RESPONSE_SPLTYPES_H
#define SAMPLE_GETSTATE_RESPONSE_SPLTYPES_H
...
#include "lifecycle_msgs/srv/dds_opensplice/GetState_Response_SplDcps.h"

#include "lifecycle_msgs/msg/rosidl_typesupport_opensplice_cpp__visibility_control.h"

extern c_metaObject __Sample_GetState_Response__lifecycle_msgs__load (c_base base);

extern c_metaObject __Sample_GetState_Response__lifecycle_msgs_srv__load (c_base base);

extern c_metaObject __Sample_GetState_Response__lifecycle_msgs_srv_dds___load (c_base base);
