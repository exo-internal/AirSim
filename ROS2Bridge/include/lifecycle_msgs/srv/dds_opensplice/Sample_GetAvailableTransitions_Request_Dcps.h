...
namespace lifecycle_msgs
{
   namespace srv
   {
      namespace dds_
      {
         ...
         typedef DDS_DCPSUVLSeq < Sample_GetAvailableTransitions_Request_, struct Sample_GetAvailableTransitions_Request_Seq_uniq_> Sample_GetAvailableTransitions_Request_Seq;
