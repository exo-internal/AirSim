#ifndef SAMPLE_CHANGESTATE_REQUEST_SPLTYPES_H
#define SAMPLE_CHANGESTATE_REQUEST_SPLTYPES_H
...
#include "lifecycle_msgs/srv/dds_opensplice/ChangeState_Request_SplDcps.h"

#include "lifecycle_msgs/msg/rosidl_typesupport_opensplice_cpp__visibility_control.h"

extern c_metaObject __Sample_ChangeState_Request__lifecycle_msgs__load (c_base base);

extern c_metaObject __Sample_ChangeState_Request__lifecycle_msgs_srv__load (c_base base);

extern c_metaObject __Sample_ChangeState_Request__lifecycle_msgs_srv_dds___load (c_base base);
