    ...
    namespace srv {
        namespace dds_ {
            ...
            DDS_TypeCode* GetAvailableTransitions_Request__get_typecode()
            {
                ...
                static DDS_TypeCode GetAvailableTransitions_Request__g_tc_node_name__string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
                ...
                GetAvailableTransitions_Request__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&GetAvailableTransitions_Request__g_tc_node_name__string;
