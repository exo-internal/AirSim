...
#ifndef MagneticField_Plugin_1820885452_h
#define MagneticField_Plugin_1820885452_h
...
namespace sensor_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define sensor_msgs__MagneticField__double_array_9Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define sensor_msgs__MagneticField__double_array_9Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define sensor_msgs__MagneticField__double_array_9Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define sensor_msgs__MagneticField__double_array_9Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define sensor_msgs__MagneticField__double_array_9Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern sensor_msgs__MagneticField__double_array_9*
            ...
            sensor_msgs__MagneticField__double_array_9PluginSupport_copy_data(
                sensor_msgs__MagneticField__double_array_9 *out,
                const sensor_msgs__MagneticField__double_array_9 *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            sensor_msgs__MagneticField__double_array_9Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            sensor_msgs__MagneticField__double_array_9Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                sensor_msgs__MagneticField__double_array_9 * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
...
#endif /* MagneticField_Plugin_1820885452_h */
