...
namespace sensor_msgs {
    namespace msg {
        namespace dds_ {
            ...
            DDS_TypeCode* sensor_msgs__NavSatFix__double_array_9_get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode sensor_msgs__NavSatFix__double_array_9_g_tc_array =DDS_INITIALIZE_ARRAY_TYPECODE(1,9, NULL,NULL);

                static DDS_TypeCode sensor_msgs__NavSatFix__double_array_9_g_tc =
                {{
                        DDS_TK_ALIAS, /* Kind*/
                        DDS_BOOLEAN_FALSE,/* Is a pointer? */
                        -1, /* Ignored */
                        (char *)"sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9", /* Name */
                        ...
                        NULL, /* Ignored */
                        DDS_VM_NONE /* Ignored */
                    }}; /* Type code for  sensor_msgs__NavSatFix__double_array_9 */

                if (is_initialized) {
                    return &sensor_msgs__NavSatFix__double_array_9_g_tc;
                }

                sensor_msgs__NavSatFix__double_array_9_g_tc_array._data._typeCode =(RTICdrTypeCode *)&DDS_g_tc_double;

                sensor_msgs__NavSatFix__double_array_9_g_tc._data._typeCode =  (RTICdrTypeCode *)& sensor_msgs__NavSatFix__double_array_9_g_tc_array;
            ...
            RTIBool sensor_msgs__NavSatFix__double_array_9_initialize(
                ...
                return sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }

            RTIBool sensor_msgs__NavSatFix__double_array_9_initialize_ex(
                sensor_msgs__NavSatFix__double_array_9* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_w_params(
                    sample,&allocParams);

            }

            RTIBool sensor_msgs__NavSatFix__double_array_9_initialize_w_params(
                sensor_msgs__NavSatFix__double_array_9* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                sensor_msgs__NavSatFix__double_array_9* sample)
            {
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_ex(sample,RTI_TRUE);
            }

            void sensor_msgs__NavSatFix__double_array_9_finalize_ex(
                sensor_msgs__NavSatFix__double_array_9* sample,RTIBool deletePointers)
            {
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_w_params(
                    sample,&deallocParams);
            }

            void sensor_msgs__NavSatFix__double_array_9_finalize_w_params(
                sensor_msgs__NavSatFix__double_array_9* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
            ...
            * Defines:  TSeq, T
            *
            * Configure and implement 'sensor_msgs__NavSatFix__double_array_9' sequence class.
            */
            #define T sensor_msgs__NavSatFix__double_array_9
            #define TSeq sensor_msgs__NavSatFix__double_array_9Seq

            #define T_initialize_w_params sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_w_params

            #define T_finalize_w_params   sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_w_params
            #define T_copy       sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_copy
            ...
            DDS_TypeCode* NavSatFix__get_typecode()
            {
                ...
                NavSatFix__g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_get_typecode();
                ...
                NavSatFix_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                if (!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_w_params(&sample->position_covariance_,
                allocParams)) {
                    return RTI_FALSE;
                }
                ...
                NavSatFix_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_w_params(&sample->position_covariance_,deallocParams);
                ...
                NavSatFix_* sample, RTIBool deletePointers)
            {
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_optional_members(&sample->position_covariance_, deallocParams->delete_pointers);
            }
                ...
                const NavSatFix_* src)
            {
                try {
                    ...
                    if (!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_copy(
                        &dst->position_covariance_,(const sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9*)&src->position_covariance_)) {
                        return RTI_FALSE;
                    } 
