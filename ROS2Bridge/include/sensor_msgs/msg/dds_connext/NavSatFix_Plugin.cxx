...
namespace sensor_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ----------------------------------------------------------------------------
            *  Type sensor_msgs__NavSatFix__double_array_9
            * -------------------------------------------------------------------------- */
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                sensor_msgs__NavSatFix__double_array_9 *sample = NULL;

                sample = new (std::nothrow) sensor_msgs__NavSatFix__double_array_9 [1];
                if (sample == NULL) {
                    return NULL;
                }

                if (!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_w_params(sample,alloc_params)) {
                    delete [] sample;
                    sample=NULL;
                }
                return sample; 
            ...
            sensor_msgs__NavSatFix__double_array_9PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete [] sample;
                    sample=NULL;
                }
            ...
            {
                return sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            sensor_msgs__NavSatFix__double_array_9PluginSupport_destroy_data_w_params(
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_w_params(sample,dealloc_params);
            ...
            sensor_msgs__NavSatFix__double_array_9PluginSupport_destroy_data_ex(
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_finalize_ex(sample,deallocate_pointers);
            ...
            sensor_msgs__NavSatFix__double_array_9PluginSupport_destroy_data(
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_copy(dst,(const sensor_msgs__NavSatFix__double_array_9*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                const sensor_msgs__NavSatFix__double_array_9 *src)
            {
                ...
                return sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
            ...
            RTIBool sensor_msgs__NavSatFix__double_array_9Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = sensor_msgs__NavSatFix__double_array_9Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool sensor_msgs__NavSatFix__double_array_9Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                sensor_msgs__NavSatFix__double_array_9 *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                unsigned int current_alignment)
            {
                ...
                size = sensor_msgs__NavSatFix__double_array_9Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * -------------------------------------------------------------------------- */
                ...
                unsigned int indent_level)
            {
                ...
                sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9PluginSupport_print_data(
                    (const sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9*) &sample->position_covariance_, "position_covariance_", indent_level + 1);
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_sample) {
                    ...
                    if(!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_serialize(
                        endpoint_data,
                        (const sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9*) &sample->position_covariance_,
                        stream,
                        RTI_FALSE, encapsulation_id,
                        RTI_TRUE,
                        endpoint_plugin_qos)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        if(!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_deserialize_sample(
                            endpoint_data,
                            &sample->position_covariance_,
                            stream,
                            RTI_FALSE, RTI_TRUE,
                            endpoint_plugin_qos)) {
                            goto fin; 
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (skip_sample) {
                    ...
                    if (!sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_skip(
                        endpoint_data,
                        stream, 
                        RTI_FALSE, RTI_TRUE, 
                        endpoint_plugin_qos)) {
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment +=sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_get_serialized_sample_max_size_ex(
                    endpoint_data, overflow, RTI_FALSE,encapsulation_id,current_alignment);
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment +=RTICdrType_getDoubleMaxSizeSerialized(
                    current_alignment);
                current_alignment +=sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_get_serialized_sample_min_size(
                    endpoint_data,RTI_FALSE,encapsulation_id,current_alignment);
                current_alignment +=RTICdrType_getOctetMaxSizeSerialized(
                    current_alignment);
            ...
            */
                ...
                const NavSatFix_ * sample) 
            {
                ...
                current_alignment += sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9Plugin_get_serialized_sample_size(
                    endpoint_data,RTI_FALSE, encapsulation_id,
                    current_alignment, (const sensor_msgs::msg::dds_::sensor_msgs__NavSatFix__double_array_9*) &sample->position_covariance_);
