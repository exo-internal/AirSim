...
#ifndef LOGGING_DEMO__SRV__CONFIG_LOGGER__RESPONSE__TYPE_SUPPORT_H_
#define LOGGING_DEMO__SRV__CONFIG_LOGGER__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // LOGGING_DEMO__SRV__CONFIG_LOGGER__RESPONSE__TYPE_SUPPORT_H_
