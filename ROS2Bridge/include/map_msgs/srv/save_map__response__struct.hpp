...
#ifndef MAP_MSGS__SRV__SAVE_MAP__RESPONSE__STRUCT_HPP_
#define MAP_MSGS__SRV__SAVE_MAP__RESPONSE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_map_msgs_srv_SaveMap_Response __attribute__((deprecated))
#else
# define DEPRECATED_map_msgs_srv_SaveMap_Response __declspec(deprecated)
#endif
...
struct SaveMap_Response_
{
  ...
  typedef DEPRECATED_map_msgs_srv_SaveMap_Response
    std::shared_ptr<map_msgs::srv::SaveMap_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_map_msgs_srv_SaveMap_Response
    std::shared_ptr<map_msgs::srv::SaveMap_Response_<ContainerAllocator> const>
...
#endif  // MAP_MSGS__SRV__SAVE_MAP__RESPONSE__STRUCT_HPP_
