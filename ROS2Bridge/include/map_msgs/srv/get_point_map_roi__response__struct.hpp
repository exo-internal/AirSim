...
#ifndef MAP_MSGS__SRV__GET_POINT_MAP_ROI__RESPONSE__STRUCT_HPP_
#define MAP_MSGS__SRV__GET_POINT_MAP_ROI__RESPONSE__STRUCT_HPP_
...
#include "sensor_msgs/msg/point_cloud2.hpp"  // sub_map

#ifndef _WIN32
# define DEPRECATED_map_msgs_srv_GetPointMapROI_Response __attribute__((deprecated))
#else
# define DEPRECATED_map_msgs_srv_GetPointMapROI_Response __declspec(deprecated)
#endif
...
struct GetPointMapROI_Response_
{
  ...
  typedef DEPRECATED_map_msgs_srv_GetPointMapROI_Response
    std::shared_ptr<map_msgs::srv::GetPointMapROI_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_map_msgs_srv_GetPointMapROI_Response
    std::shared_ptr<map_msgs::srv::GetPointMapROI_Response_<ContainerAllocator> const>
...
#endif  // MAP_MSGS__SRV__GET_POINT_MAP_ROI__RESPONSE__STRUCT_HPP_
