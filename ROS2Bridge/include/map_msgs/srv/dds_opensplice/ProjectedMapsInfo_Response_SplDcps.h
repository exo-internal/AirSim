#ifndef PROJECTEDMAPSINFO_RESPONSE_SPLTYPES_H
#define PROJECTEDMAPSINFO_RESPONSE_SPLTYPES_H
...
extern c_metaObject __ProjectedMapsInfo_Response__map_msgs__load (c_base base);

extern c_metaObject __ProjectedMapsInfo_Response__map_msgs_srv__load (c_base base);

extern c_metaObject __ProjectedMapsInfo_Response__map_msgs_srv_dds___load (c_base base);
