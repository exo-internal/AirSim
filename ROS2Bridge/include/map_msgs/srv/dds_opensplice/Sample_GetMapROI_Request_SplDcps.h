#ifndef SAMPLE_GETMAPROI_REQUEST_SPLTYPES_H
#define SAMPLE_GETMAPROI_REQUEST_SPLTYPES_H
...
#include "map_msgs/srv/dds_opensplice/GetMapROI_Request_SplDcps.h"

#include "map_msgs/msg/rosidl_typesupport_opensplice_cpp__visibility_control.h"

extern c_metaObject __Sample_GetMapROI_Request__map_msgs__load (c_base base);

extern c_metaObject __Sample_GetMapROI_Request__map_msgs_srv__load (c_base base);

extern c_metaObject __Sample_GetMapROI_Request__map_msgs_srv_dds___load (c_base base);
