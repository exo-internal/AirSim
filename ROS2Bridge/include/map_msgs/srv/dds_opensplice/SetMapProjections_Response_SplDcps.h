#ifndef SETMAPPROJECTIONS_RESPONSE_SPLTYPES_H
#define SETMAPPROJECTIONS_RESPONSE_SPLTYPES_H
...
extern c_metaObject __SetMapProjections_Response__map_msgs__load (c_base base);

extern c_metaObject __SetMapProjections_Response__map_msgs_srv__load (c_base base);

extern c_metaObject __SetMapProjections_Response__map_msgs_srv_dds___load (c_base base);
