...
#include "sensor_msgs/msg/point_cloud2.hpp"  // points
#include "std_msgs/msg/header.hpp"  // header

#ifndef _WIN32
# define DEPRECATED_map_msgs_msg_PointCloud2Update __attribute__((deprecated))
#else
# define DEPRECATED_map_msgs_msg_PointCloud2Update __declspec(deprecated)
#endif
...
struct PointCloud2Update_
{
  ...
  typedef DEPRECATED_map_msgs_msg_PointCloud2Update
    std::shared_ptr<map_msgs::msg::PointCloud2Update_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_map_msgs_msg_PointCloud2Update
    std::shared_ptr<map_msgs::msg::PointCloud2Update_<ContainerAllocator> const>
