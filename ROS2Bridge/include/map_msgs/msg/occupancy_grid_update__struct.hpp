...
#ifndef _WIN32
# define DEPRECATED_map_msgs_msg_OccupancyGridUpdate __attribute__((deprecated))
#else
# define DEPRECATED_map_msgs_msg_OccupancyGridUpdate __declspec(deprecated)
#endif
...
struct OccupancyGridUpdate_
{
  ...
  typedef DEPRECATED_map_msgs_msg_OccupancyGridUpdate
    std::shared_ptr<map_msgs::msg::OccupancyGridUpdate_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_map_msgs_msg_OccupancyGridUpdate
    std::shared_ptr<map_msgs::msg::OccupancyGridUpdate_<ContainerAllocator> const>
